...
(function(){
    ...
    app.controller('indexCtr', function($scope, $http){
        ...
        $scope.loadHistoryRank = function(){
            ...
            $http.post("/game/history",{type:1,skip:skip,limit:$scope.history_rank.limit},{}).then(function(res){
                if(res.data.message == 'success'){
        ...
        $scope.loadFriendHistory = function(){
            ...
            $http.post("/game/history",{type:2,skip:skip,limit:$scope.history_friend.limit},{}).then(function(res){
                if(res.data.message == 'success'){
