...
module.exports.bootstrap = function(cb) {
	...
	var createAdminDefault = function(){
    	return new Promise(function(fullfill, reject){
    		User.findOrCreate({email:'yukiivietnam@gmail.com'}
			,{email:'yukiivietnam@gmail.com', isActive:true, displayName:'yukiAdmin', password:'abc123', role:'admin', picture:'/images/avatar-default.png'})
